        ...
        <div class="row justify-content-md-center">
            ...
            <div class="col-md-11">
                ...
                <div class="card ">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route('users.update',$item->id)}}" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body custom-design">

                            <div class="form-group row">
                                <label class="col-md-3 col-sm-3 col-xs-4 control-label">اسم العضو  </label>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-sm-3 col-xs-4 control-label">البريد الالكتروني </label>
                                <div class="col-md-6 col-sm-9 col-xs-8">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-sm-3 col-xs-4 control-label">الرقم السري </label>
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                    <input required type="password"  value="{{$item->password}}" class="form-control" name="password" >
                                </div>
                            </div>
