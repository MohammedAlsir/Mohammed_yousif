                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-9 col-xs-8">
                                    <select required class="form-control" name="family_type" id="">
                                        ...
                                        <option {{$item->family_type == 'اسرة صغيرة' ? 'selected':'' }}  " value="اسرة صغيرة">اسرة صغيرة</option>
                                        <option {{$item->family_type == 'اسرة متوسطة' ? 'selected':'' }} value="اسرة متوسطة">اسرة متوسطة</option>
                                        <option {{$item->family_type == 'اسرة كبيرة' ? 'selected':'' }} value="اسرة كبيرة">اسرة كبيرة</option>
                                    </select>
                                </div>
                            </div>
